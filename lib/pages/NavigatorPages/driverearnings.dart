                        ...
                        Column(children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    MyText(
                                      text:
                                          '${driverTodayEarnings['currency_symbol']} ${driverTodayEarnings['total_wallet_trip_amount'].toStringAsFixed(2)}',
                                      size: media.width * sixteen,
                                    )
                                  ],
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                MyText(
                                  text:
                                      '${driverTodayEarnings['currency_symbol']} ${driverTodayEarnings['total_cash_trip_amount'].toStringAsFixed(2)}',
                                  size: media.width * sixteen,
                                ),
                              ],
                            ),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        MyText(
                                          text:
                                              '${driverWeeklyEarnings['currency_symbol']} ${driverWeeklyEarnings['total_wallet_trip_amount'].toStringAsFixed(2)}',
                                          size: media.width * sixteen,
                                        )
                                      ],
                                    ),
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        MyText(
                                          text:
                                              '${driverWeeklyEarnings['currency_symbol']} ${driverWeeklyEarnings['total_cash_trip_amount'].toStringAsFixed(2)}',
                                          size: media.width * sixteen,
                                        ),
                                      ],
                                    ),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      MyText(
                                        text:
                                            '${driverWeeklyEarnings['currency_symbol']} ${driverWeeklyEarnings['total_earnings'].toStringAsFixed(2)}',
                                        size: media.width * sixteen,
                                        color: buttonColor,
                                      ),
                                    ],
                                      ...
                                      (driverReportEarnings.isNotEmpty)
                                          ? Column(
                                              children: [
                                                MyText(
                                                  text:
                                                      '${driverReportEarnings['from_date']} - ${driverReportEarnings['to_date']}',
                                                  size: media.width * fifteen,
                                                  color: hintColor,
                                                ),
                                                SizedBox(
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${driverReportEarnings['currency_symbol']} ${driverReportEarnings['total_wallet_trip_amount'].toStringAsFixed(2)}',
                                                          style: GoogleFonts
                                                              .notoSans(
                                                                  fontSize: media
                                                                          .width *
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${driverReportEarnings['currency_symbol']} ${driverReportEarnings['total_cash_trip_amount'].toStringAsFixed(2)}',
                                                          style: GoogleFonts
                                                              .notoSans(
                                                                  fontSize: media
                                                                          .width *
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        '${driverReportEarnings['currency_symbol']} ${driverReportEarnings['total_earnings'].toStringAsFixed(2)}',
                                                        style: GoogleFonts
                                                            .notoSans(
                                                                fontSize: media
                                                                        .width *
