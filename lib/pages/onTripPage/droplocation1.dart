...
//   final dynamic type;
//   const DropLocation({super.key, this.type});
...
//       });
//     }
//     print('djhbcjkdbcjsdlbvjklskdvbnklsd' + _center.toString());
//   }
...
//                                           (isDarkTheme == false)?'https://tile.openstreetmap.org/{z}/{x}/{y}.png':'https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png',
...
//                                   Button(
//                                       onTap: () async {
//                                         print('sdfjnvklnsdnvsdknvn');
//                                         if (dropAddressConfirmation != '') {
//                                           print('sdjvbsdjkvklsdnvskdnlvnsd');
//                                           //remove in envato
//                                           if (addressList
//                                               .where((element) =>
//                                                   element.type == 'drop')
//                                               .isEmpty) {
//                                             print(
//                                                 'sdvjbsjdkbvjbskdvlbsdlbkvbjlksd');
//                                             addressList.add(AddressList(
...
//                                                     _center.longitude)));
//                                           } else {
//                                             print('sfdjvsdkjnvldsknvsdnklvnks');
//                                             addressList
//                                                     .firstWhere((element) =>
//                                                         element.type == 'drop')
//                                                     .address =
...
//                                                                       e['id'] ==
//                                                                       int.parse(
//                                                                           selectedGoodsId))['goods_type_name'] +
//                                                                   ' (' +
//                                                                   goodsSize +
//                                                                   ')',
//                                                               style: GoogleFonts.notoSans(
...
//                                                           if (widget.type ==
//                                                               null) {
//                                                             val = await createRequest(
//                                                                 username.text,
//                                                                 userphonenumber
//                                                                     .text);
//                                                           } else {
//                                                             val = await createRequestDelivery(
//                                                                 username.text,
//                                                                 userphonenumber
//                                                                     .text);
//                                                           }
...
//                                                               'success') {
//                                                             print(
//                                                                 'cjkvjkdscjbdaklbcklbdalbkcdklvbkdsvkbld');
//                                                             var result =
