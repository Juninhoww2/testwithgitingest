...
class CarInformation extends StatefulWidget {
  int? frompage;
  CarInformation({this.frompage, super.key});
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        (custommakecontroller.text.isNotEmpty)
                                            ? Colors.transparent
                                            : const Color(0xFFD9D9D9)
                                                .withOpacity(0.31),
                                    // color:(myServiceId != '') ? page : Color(0xFFE8EAE9),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      if (custommakecontroller.text.isEmpty)
                                        Icon(
                                          Icons.lock_outline_rounded,
                                          size: media.width * 0.05,
                                          color: whiteText,
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        (custommodelcontroller.text.isNotEmpty)
                                            ? Colors.transparent
                                            : const Color(0xFFD9D9D9)
                                                .withOpacity(0.31),
                                    // color:(myServiceId != '') ? page : Color(0xFFE8EAE9),
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: Container(
                                          ...
                                          child: InputField(
                                            ...
                                            maxLength: 4,
                                            readonly: (custommodelcontroller
                                                    .text.isEmpty)
                                                ? true
                                                : false,
                                      ...
                                      if (custommodelcontroller.text.isEmpty)
                                        Icon(
                                          Icons.lock_outline_rounded,
                                          size: media.width * 0.05,
                                          color: whiteText,
